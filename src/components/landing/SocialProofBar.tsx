...
const categories = [
  ...
  { icon: Flower2, label: 'Spa & Beauty', gradient: 'from-pink-400 to-purple-500', bg: 'bg-pink-50', hoverBg: 'group-hover:bg-pink-100' },
  { icon: HeartPulse, label: 'Fitness', gradient: 'from-emerald-400 to-teal-500', bg: 'bg-emerald-50', hoverBg: 'group-hover:bg-emerald-100' },
  { icon: Clapperboard, label: 'Entertainment', gradient: 'from-violet-400 to-indigo-500', bg: 'bg-violet-50', hoverBg: 'group-hover:bg-violet-100' },
