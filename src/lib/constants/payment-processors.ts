...
export const PAYMENT_PROCESSORS: Record<PaymentProcessorType, PaymentProcessorInfo> = {
  ...
  square: {
    ...
    helpText: 'Paste your Square checkout link.',
  ...
  paypal: {
    ...
    helpText: 'Connect your PayPal Business account for automated payments, or paste a PayPal.me link.',
  ...
  venmo: {
    ...
    helpText: 'Enter your Venmo username so customers know you accept Venmo at your location.',
  ...
  zelle: {
    ...
    helpText: 'Enter your Zelle email or phone so customers know you accept Zelle at your location.',
    supportsDeposit: false,
    integratable: false,
    supportedTiers: ['manual'],
  },
  cashapp: {
    ...
    helpText: 'Enter your Cash App tag so customers know you accept Cash App at your location.',
    supportsDeposit: false,
    integratable: false,
    supportedTiers: ['manual'],
  },
