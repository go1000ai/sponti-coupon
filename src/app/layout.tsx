  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="SpontiCoupon" />
        {/* Google Analytics 4 */}
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=1852542762164797&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
