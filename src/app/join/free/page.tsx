          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input name="city" type="text" value={form.city} onChange={handleChange} className="input-field" placeholder={t('Orlando', 'San Juan')} />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t('State', 'Estado')}</label>
                <input name="state" type="text" value={form.state} onChange={handleChange} className="input-field" placeholder="FL" />
              </div>
              <div>
