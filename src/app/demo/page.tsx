...
export const metadata: Metadata = {
  ...
  description: 'Watch how SpontiCoupon helps local businesses attract more customers, build loyalty, and grow revenue — in under 4 minutes.',
  openGraph: {
    ...
    images: ['/videos/tutorial-thumb.jpg'],
  },
};
      ...
      <div className="border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <img src="/logo.png" alt="SpontiCoupon" className="h-10 w-auto" />
          </Link>
          <Link
            href="/auth/signup?role=vendor"
            className="bg-gradient-to-r from-[#E8632B] to-[#FF8C42] text-white font-bold px-6 py-2.5 rounded-xl text-sm hover:shadow-lg hover:shadow-orange-500/30 transition-all"
          >
            Get Started Free
          </Link>
        </div>
