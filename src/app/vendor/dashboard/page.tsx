    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <Link href="/vendor/insights" className="card p-5 flex items-center gap-4 hover:shadow-lg transition-all group tilt-card animate-fade-up" style={{ animationDelay: '780ms' }}>
          <div className="bg-gradient-to-br from-primary-500 to-amber-400 rounded-xl p-3 text-white shadow-lg shadow-primary-200 group-hover:scale-110 transition-transform">
