...
export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <h1 className="text-4xl font-bold text-secondary-500 mb-2">Terms of Service</h1>
      ...
      <div className="prose prose-gray max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">3. User Accounts</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">4. Sponti Coupons &amp; Time-Limited Deals</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">5. Deposits &amp; Payments</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">6. Redemption Codes &amp; QR Codes</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">7. Vendor Responsibilities</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">8. Limitation of Liability</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">11. Prohibited Conduct</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">13. Termination</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">14. Governing Law</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-secondary-500">15. Contact Information</h2>
          <p className="text-gray-600 leading-relaxed">
