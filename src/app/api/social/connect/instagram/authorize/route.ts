...
/**
 * GET /api/social/connect/instagram/authorize
 * Redirects vendor to Meta OAuth with Instagram publishing permissions.
 * Instagram posting requires a Facebook Page linked to an Instagram Business Account.
 */
export async function GET(request: NextRequest) {
  ...
  // Instagram Content Publishing requires these scopes
