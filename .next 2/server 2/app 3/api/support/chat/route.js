"use strict";(()=>{var e={};e.id=1968,e.ids=[1968],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},36864:(e,t,s)=>{s.r(t),s.d(t,{originalPathname:()=>w,patchFetch:()=>v,requestAsyncStorage:()=>f,routeModule:()=>g,serverHooks:()=>S,staticGenerationAsyncStorage:()=>b});var a={};s.r(a),s.d(a,{POST:()=>y});var o=s(49303),n=s(88716),i=s(60670),r=s(87070),l=s(80213),d=s(65655),p=s(76097);let u=`You are Mia, SpontiCoupon's friendly support assistant.
...
- Subscription/platform billing (monthly plan fees) is handled separately through Stripe.`,c=`
...
- The money goes directly to the vendor — SpontiCoupon never touches it.`,h=`
...
- If they ask about payment methods, explain that deposits are paid online via the vendor's primary method (Stripe, Square, or PayPal). Vendors may also accept Venmo, Zelle, or Cash App at the business for the remaining balance.`,m=`
...
- If they compare to competitors, keep it brief: zero commission means better deals, all businesses verified, plus you earn rewards.`;async function y(e){let t;let s=(0,p.h)(e,{maxRequests:20,windowMs:9e5,identifier:"mia-chat"});if(s)return s;try{t=await e.json()}catch{return r.NextResponse.json({error:"Invalid JSON"},{status:400})}let{messages:a,userRole:o,vendorId:n,origin:i}=t;if(!a||!Array.isArray(a)||0===a.length)return r.NextResponse.json({error:"messages array is required"},{status:400});let y=process.env.SPONTI_ANTHROPIC_KEY||process.env.ANTHROPIC_API_KEY;if(!y)return r.NextResponse.json({reply:"Thanks for reaching out! I'm having a little trouble connecting right now. You can open a support ticket below and our team will get back to you shortly."});let g=(u+("vendor"===o?c:"visitor"===o?m:h)).replaceAll("{{BASE_URL}}",i||"http://localhost:3000"),f=n;if("vendor"===o&&!f)try{let e=await (0,d.f)(),{data:{user:t}}=await e.auth.getUser();t&&(f=t.id)}catch{}if(f&&"visitor"!==o)try{let e=await (0,d.createServiceRoleClient)(),{data:t}=await e.from("vendor_knowledge_base").select("question, answer, category").eq("vendor_id",f).limit(50);if(t&&t.length>0){let e=t.map(e=>`Q: ${e.question}
A: ${e.answer}`).join("\n\n");g+=`

Business-specific knowledge base (use this to answer questions about this business):
${e}`}}catch{}try{let e=new l.ZP({apiKey:y}),t=(await e.messages.create({model:"claude-sonnet-4-20250514",max_tokens:300,system:g,messages:a.map(e=>({role:e.role,content:e.content})),temperature:.7})).content[0];if("text"===t.type)return r.NextResponse.json({reply:t.text.trim()});return r.NextResponse.json({reply:"I'm sorry, I had trouble processing that. Could you try rephrasing your question?"})}catch(e){return console.error("[Mia Chat] Error:",e),r.NextResponse.json({reply:"I'm having a little trouble right now. If you need immediate help, please open a support ticket below and our team will assist you."})}}let g=new o.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/support/chat/route",pathname:"/api/support/chat",filename:"route",bundlePath:"app/api/support/chat/route"},resolvedPagePath:"/Users/hsantiago15/Documents/SpontiCoupon/sponti-coupon/src/app/api/support/chat/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:f,staticGenerationAsyncStorage:b,serverHooks:S}=g,w="/api/support/chat/route";function v(){return(0,i.patchFetch)({serverHooks:S,staticGenerationAsyncStorage:b})}},76097:(e,t,s)=>{s.d(t,{h:()=>n});var a=s(87070);let o=new Map;function n(e,{maxRequests:t,windowMs:s,identifier:n}){let i=e.headers.get("x-forwarded-for")?.split(",")[0]?.trim()||e.headers.get("x-real-ip")||"unknown",r=`${n||e.nextUrl.pathname}:${i}`,l=Date.now(),d=o.get(r);if(!d||l>d.resetAt)return o.set(r,{count:1,resetAt:l+s}),null;if(d.count++,d.count>t){let e=Math.ceil((d.resetAt-l)/1e3);return a.NextResponse.json({error:"Too many requests. Please try again later."},{status:429,headers:{"Retry-After":String(e)}})}return null}setInterval(()=>{let e=Date.now();o.forEach((t,s)=>{e>t.resetAt&&o.delete(s)})},3e5)},65655:(e,t,s)=>{s.d(t,{createServiceRoleClient:()=>i,f:()=>n});var a=s(67721),o=s(71615);async function n(){let e=await (0,o.cookies)();return(0,a.createServerClient)("https://ypoytvqxuxpjipcyaxwg.supabase.co","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inlwb3l0dnF4dXhwamlwY3lheHdnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE3MzAyMzQsImV4cCI6MjA4NzMwNjIzNH0.JPVYvULezPNCxIElpBbUug-7q7aIuhUaSi5D7cw07XE",{cookies:{getAll:()=>e.getAll(),setAll(t){try{t.forEach(({name:t,value:s,options:a})=>e.set(t,s,a))}catch{}}}})}async function i(){let{createClient:e}=await Promise.resolve().then(s.bind(s,37857));return e("https://ypoytvqxuxpjipcyaxwg.supabase.co",process.env.SUPABASE_SERVICE_ROLE_KEY,{auth:{autoRefreshToken:!1,persistSession:!1}})}}};var t=require("../../../../webpack-runtime.js");t.C(e);var s=e=>t(t.s=e),a=t.X(0,[8948,5972,7721,6170],()=>s(36864));module.exports=a})();